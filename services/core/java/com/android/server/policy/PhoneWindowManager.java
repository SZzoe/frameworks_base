...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private static final int MSG_BACK_DELAYED_PRESS = 22;
    ...
    private EdgeGestureManager.EdgeGestureActivationListener mEdgeGestureActivationListener
        ...
        public void onEdgeGestureActivation(int touchX, int touchY,
            ...
            if (position == EdgeGesturePosition.TOP) {
                target = mStatusBar;
            } else if (position == EdgeGesturePosition.BOTTOM  && (NAV_BAR_BOTTOM == 0)) {
                target = mNavigationBar;
            } else if (position == EdgeGesturePosition.LEFT
                    && (NAV_BAR_BOTTOM != 0) && mNavigationBarLeftInLandscape) {
                target = mNavigationBar;
            } else if (position == EdgeGesturePosition.RIGHT && ((NAV_BAR_BOTTOM != 0) && !mNavigationBarLeftInLandscape)) {
                target = mNavigationBar;
            }
    ...
    public void init(Context context, IWindowManager windowManager,
        ...
        mCustomBackKillTimeout = mContext.getResources().getInteger(
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            mCustomBackKillTimeout = Settings.Secure.getIntForUser(resolver,
                    ...
                    mCustomBackKillTimeout, UserHandle.USER_CURRENT);
